    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-zinc-900 text-white">
      ...
      <nav className="p-5 shadow-sm flex justify-between items-center bg-zinc-900 border-b border-zinc-800 rounded-bl-3xl rounded-br-3xl nav-slide-down sticky-nav">
        ...
        >
          ...
          <h2 className="font-bold text-lg bg-gradient-to-r from-slate-800 via-cyan-400 to-green-400 text-transparent bg-clip-text" suppressHydrationWarning={true}>DecorMind</h2>
        </div>
        ...
        <div className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 items-center">
          <nav className="flex gap-4 md:gap-6 mx-auto justify-center flex-wrap" style={{ fontSize: '0.875rem' }}>
            <Link 
              href="/" 
              className="nav-link text-white hover:text-cyan-400 transition-colors relative"
              onClick={(e) => {
                e.preventDefault();
                handleLinkClick('/');
              }}
            ...
            <Link
              href="/contact-us"
              className="nav-link text-cyan-400 active transition-colors relative"
            >
              Contact Us
            </Link>
          </nav>
        ...
        <button className="md:hidden text-white" onClick={toggleMobileMenu} suppressHydrationWarning={true}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className={`md:hidden fixed top-16 left-0 right-0 z-40 bg-zinc-900 shadow-md border-b border-zinc-800 transition-all duration-300 ${mobileMenuOpen ? 'block' : 'hidden'}`}>
        ...
        <Link 
          href="/contact-us" 
          className="block py-2 w-full text-center text-cyan-400"
          onClick={(e) => {
            e.preventDefault();
            closeMobileMenu();
          }}
